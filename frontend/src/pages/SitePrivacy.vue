<template>
    <div>
        ...
        <p class="mb-2">
            ...
            персональных данных, предпринимаемые ООО «Альма Медиа Системс» (далее – Оператор).
        </p>
        <p class="mb-2">
            <b>1.1. </b>
        ...
        <p class="mb-2">
            ...
            или определяемому Пользователю веб-сайта almamarket.ru.
        </p>
        <p class="mb-2">
            <b>2.9. </b>
            Пользователь – любой посетитель веб-сайта almamarket.ru.
        </p>
        <p class="mb-2">
            <b>2.10. </b>
        ...
        <h3 class="mb-3">4. Цели обработки персональных данных</h3>
        <p class="mb-2">
            <b>4.1. </b>
        ...
        <p class="mb-2">
            ...
            электронной почты krofly03@mail.ru с пометкой «Отказ от уведомлений о новых продуктах и
        ...
        <h3 class="mb-3">5. Правовые основания обработки персональных данных</h3>
        <p class="mb-2">
            <b>5.1. </b>
            ...
            сайте almamarket.ru. Заполняя соответствующие формы и/или отправляя свои персональные
        ...
        <p class="mb-2">
            ...
            Оператора krofly03@mail.ru с пометкой «Актуализация персональных данных».
        </p>
        <p class="mb-2">
            <b>6.4. </b>
            ...
            krofly03@mail.ru с пометкой «Отзыв согласия на обработку персональных данных».
        </p>

        <h3 class="mb-3">7. Трансграничная передача персональных данных</h3>
        <p class="mb-2">
            <b>7.1. </b>
        ...
        <h3 class="mb-3">8. Заключительные положения</h3>
        <p class="mb-2">
            <b>8.1. </b>
